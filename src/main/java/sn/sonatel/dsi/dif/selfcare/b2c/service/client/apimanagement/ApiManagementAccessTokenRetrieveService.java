...
public class ApiManagementAccessTokenRetrieveService {
    ...
    String retrieveToken(){
        ...
        ResponseEntity<AuthenticationToken> response = restTemplate.postForEntity(applicationProperties.getApiManagement().getKeyAccessTokenUri(), request, AuthenticationToken.class);
