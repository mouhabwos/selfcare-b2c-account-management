...
public class FileInformationServiceImpl implements FileInformationService {
    ...
    public FileInformation save(String sourceFile, Date dateCreation) {
        ...
        try {
            ...
            File resourcesDirectory = new File(sourceFile);
            MockMultipartFile file = new MockMultipartFile("file", resourcesDirectory.getName(), "", Files.readAllBytes(resourcesDirectory.toPath()));
    ...
    private ResponseEntity<String> uploadFile(MultipartFile file) throws IOException {
        ...
        parameters.add("file", new FileSystemResource(convert(file)));
    ...
    public static File convert(MultipartFile file) throws IOException {
        ...
        try (FileOutputStream  fos = new FileOutputStream(convFile);){
            ...
            log.error("Error FileOutputStream with message : {}", ex.getMessage());
        }
        return convFile;
    }
}
