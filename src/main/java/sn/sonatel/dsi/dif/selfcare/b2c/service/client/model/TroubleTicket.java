...
@XmlEnumValue("ACKNOWLEDGED") ACKNOWLEDGED(String.valueOf("ACKNOWLEDGED")), @XmlEnumValue("REJECTED") REJECTED(String.valueOf("REJECTED")), @XmlEnumValue("PENDING") PENDING(String.valueOf("PENDING")), @XmlEnumValue("HELD") HELD(String.valueOf("HELD")), @XmlEnumValue("INPROGRESS") INPROGRESS(String.valueOf("INPROGRESS")), @XmlEnumValue("CANCELLED") CANCELLED(String.valueOf("CANCELLED")), @XmlEnumValue("CLOSED") CLOSED(String.valueOf("CLOSED")), @XmlEnumValue("RESOLVED") RESOLVED(String.valueOf("RESOLVED")), @XmlEnumValue("UNKNOWN") UNKNOWN(String.valueOf("UNKNOWN"));
...
@XmlEnumValue("INCIDENT") INCIDENT(String.valueOf("INCIDENT")), @XmlEnumValue("REQUEST") REQUEST(String.valueOf("REQUEST"));
