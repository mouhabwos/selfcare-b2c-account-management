...
public class CustomerOfferRetrieveService {
    ...
    public ResponseEntity<CustomerOffer> getCachedCustomerOffer(String msisdn) {
        log.debug("Retrieving cached api management customer offer for user {} ", msisdn);

        ResponseEntity<CustomerOffer> result = customerOfferApiClient.getCustomerOffer(msisdn);
    ...
    public ResponseEntity<CustomerOffer> updateCachedCustomerOffer(String msisdn) {
        log.debug(" Retrieving cached api management customer offer for user {} ", msisdn);
