...
public class AccountB2CSecurityService {
    ...
    public AccountB2CSecurityService(JHipsterProperties jHipsterProperties, @Qualifier("loadBalancedRestTemplate") RestTemplate restTemplate, AccountB2CService accountB2CService, ValidationHmacService validationHmacService, OAuth2TokenEndpointClient authorizationClient) {
