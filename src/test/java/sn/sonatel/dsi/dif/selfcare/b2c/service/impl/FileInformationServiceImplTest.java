...
@IntegrationTest
class FileInformationServiceImplTest {
    ...
    void testSaveFileInformation() {
        ...
        Mockito
            ...
            .thenReturn(ResponseEntity.ok(fileNameResponse));
    ...
    @Test
    void testSaveFileInformationWithEmptyBody() {
        String sourceFile = "src/test/resources/files/numero.csv";
        Date date = new Date();
    ...
    @Test
    void testSaveFileInformationWithErrorUploadFile() {
        String sourceFile = "src/test/resources/files/numero.csv";
        Date date = new Date();

        Mockito
            .when(restTemplate.exchange(Mockito.anyString(), Mockito.any(), Mockito.any(), Mockito.any(Class.class)))
    ...
    @Test
    void testSaveFileInformationWithErrorFilename() {
        String sourceFile = "src/test/resources/files/numero.csvd";
        Date date = new Date();

        FileInformation information = fileInformationServiceImpl.save(sourceFile, date, "test@orange-sonatel.com");

        Assertions.assertNull(information.getFileName());
    }
}
