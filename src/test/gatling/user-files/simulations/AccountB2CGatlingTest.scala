...
class AccountB2CGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the AccountB2C entity")
        ...
        .repeat(2) {
            ...
            .get("/selfcare-b2c-account-management/api/account-b-2-cs")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new accountB2C")
            .post("/selfcare-b2c-account-management/api/account-b-2-cs")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "numero":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/selfcare-b2c-account-management${new_accountB2C_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created accountB2C")
            .delete("/selfcare-b2c-account-management${new_accountB2C_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
